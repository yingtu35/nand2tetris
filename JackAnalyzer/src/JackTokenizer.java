...
/** JackTokenizer.java
 * 	represent a JackTokenizer that convert a jack file to a tokenized XML file
...
public class JackTokenizer {
	...
	private boolean multipleComment = false; // if current line is part of a multi-line comment
...
//		System.out.println(inputFileContent);
	...
	private void parse() throws IOException{
		this.outputFilePath = inputFilePath.split("\\.")[0] + ".xml";
	...
	private void outputXML() throws IOException{
		outputFileContent = "<tokens>" + "\n" + outputFileContent + "</tokens>";
		
		this.outputFilePath = inputFilePath.split("\\.")[0] + "T.xml";
